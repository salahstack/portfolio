const socialLinks = [
  ...
  {
    href: 'https://www.linkedin.com/in/salaheddine-mjydila',
    icon: (
      <svg
        width='24'
        height='24'
  ...
  {
    href: 'https://www.instagram.com/mjydila_salaheddine',
    icon: (
      <svg
        width='25'
        height='24'
  ...
  return (
    ...
    >
      <div className='container lg:grid grid-cols-2 lg:items-stretch'>
        ...
        <form
          action='https://getform.io/f/bolopwga'
          method='POST'
          className='xl:pl-10 2xl:pl-20'
        >
          <div className='md:grid grid-items-center md:grid-cols-2 md:gap-2'>
            <div className='mb-4'>
              <label
                htmlFor='name'
              ...
              <input
                ...
                autoComplete='name'
                required
                placeholder='Salaheddine Mjydila'
            ...
            <div className='mb-4'>
              ...
              <input
                ...
                autoComplete='email'
                required
                placeholder='salaheddine@example.com'
                className='text-field reveal-up'
              />
            </div>
          </div>
